...
export default function EnlaceDashboard() {
  ...
  const modulos = [
    { href:'/dashboard/enlace/estudiantes', icon:'🎓', title:'Estudiantes de mi sede',    desc:'Ver listado y datos de todos los estudiantes',     color:'border-blue-200 hover:border-blue-400',   permiso: null },
    ...
    <div className="ap">
      ...
      <div className="pc">
        ...
        {!loading && Object.keys(porEtapa).length > 0 && (
          <div className="card">
            <div className="card-title">📚 Estudiantes por etapa en tu sede</div>
        ...
        {!loading && e.totalEstudiantes === 0 && (
          <div className="card text-center py-10 text-gray-400">
            ...
            <div className="font-semibold text-gray-600">Sin estudiantes en tu sede para {ciclo}</div>
