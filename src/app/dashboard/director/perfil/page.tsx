'use client'
// src/app/dashboard/director/perfil/page.tsx — NUEVA PÁGINA
...
export default function DirectorPerfilPage() {
  ...
  return (
    <div className="ap">
      <header className="topbar"><div className="page-title">👤 Mi Perfil — Director</div></header>
      <div className="pc max-w-2xl space-y-5">
        {msg && <div className={`alert ${msg.startsWith('✅') ? 'al-s' : 'al-e'}`}>{msg}</div>}

        <div className="card">
          <div className="card-title">🏛️ Datos del Director</div>
          <div className="grid grid-cols-2 gap-x-6 gap-y-3 text-sm">
            {[
              ...
              ['Municipio sede',  (p?.sede as any)?.municipio?.nombre ?? '—'],
