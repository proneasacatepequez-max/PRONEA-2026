...
function EscalasContent() {
  ...
  const guardarNota = async (tipo: 'tarea' | 'examen', itemId: string, nota: number | null) => {
    ...
    if (res.ok) {
      ...
      // Recalcular resumen (ambos libros): si ya se registraron todas las
      // notas de tareas y exámenes de la etapa, la inscripción se marca
      // automáticamente como "completada".
      try {
